    ...
    return (
        <div className="flex flex-col gap-6">
            {education.map((edu, idx) => (
                <div
                    key={idx}
                    className="relative bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all border border-gray-700 hover:border-blue-500/30 group overflow-hidden"
                >
                    {/* Decorative elements */}
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <p className="text-blue-400 font-medium">{edu.courseName}</p>
                                </div>
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-2 mb-3 text-gray-400">
                            ...
                            <span className="text-sm font-medium">Key Skills & Technologies</span>
                        </div>
                        <div className="flex flex-wrap gap-2">
                            {edu.skills.map((skill, i) => (
                                <span
                                    key={i}
                                    className="px-3 py-1 bg-gray-700/50 text-gray-300 text-sm rounded-full border border-gray-600 hover:bg-blue-500/20 hover:border-blue-500/30 hover:text-blue-300 transition-all"
                                >
                                    {skill}
                                </span>
                            ))}
